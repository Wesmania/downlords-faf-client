...
interface GameUpdater {
     ...
     */
    fun addFeaturedModUpdater(featuredModUpdater: FeaturedModUpdater): GameUpdater

    /**
     * @param featuredMod the featured "base" mod is the one onto which other mods base on (usually [ ][KnownFeaturedMod.DEFAULT]).
     ...
     */
    fun update(featuredMod: FeaturedMod, version: Int?, featuredModVersions: Map<String, Int>, simModUids: Set<String>): CompletableFuture<Void>
}
