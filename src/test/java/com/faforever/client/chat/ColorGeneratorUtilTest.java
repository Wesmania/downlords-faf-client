...
public class ColorGeneratorUtilTest {
  ...
  public void testGenerateRandomHexColorRandomness() {
    ...
    for (int i = 0; i < 10; i++) {
      Color resultColor = ColorGeneratorUtil.Companion.generateRandomColor(seed);
    ...
    for (int i = 0; i < 10; i++) {
      Color resultColor = ColorGeneratorUtil.Companion.generateRandomColor(seed2);
    ...
    for (int i = 0; i < 10; i++) {
      Color resultColor = ColorGeneratorUtil.Companion.generateRandomColor(seed3);
